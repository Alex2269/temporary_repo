...
static bool Gui_Square_Button(Rectangle bounds, PSF_Font font, const char *text,
...
int Gui_RadioButtons_Row(Rectangle bounds, PSF_Font font, const char **items, int itemCount, int currentIndex, Color colorActive, int buttonSize, int spacing)
{
